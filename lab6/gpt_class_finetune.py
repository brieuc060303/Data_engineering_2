...
# ---
#
# This is a summary file containing the main takeaways from lab 6.
...
def download_and_unzip_spam_data(url, zip_path, extracted_path, data_file_path, test_mode=False):
    ...
    else:  # Code as it appears in the lab
        # Downloading the file
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=("This flag runs the model in test mode for internal testing purposes. "
              "Otherwise, it runs the model as it is used in the lab (recommended).")
    )
    ...
    # Code as it is used in the main lab
    else:
